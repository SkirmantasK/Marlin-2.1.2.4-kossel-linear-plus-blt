...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 411.08 }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 */
  ...
  //#define X_NOZZLE_TO_PROBE_OFFSET -31     // X offset: -left  +right  [of the nozzle]
  //#define Y_NOZZLE_TO_PROBE_OFFSET +19   // Y offset: -front +behind [the nozzle]
  //#define Z_NOZZLE_TO_PROBE_OFFSET +6.975  // Z offset: -below +above  [the nozzle]
  #define NOZZLE_TO_PROBE_OFFSET {-31.4,19,6.900 }
